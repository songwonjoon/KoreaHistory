...
<style type="text/css">
body{
	background-image: url("../resources/img/login/new_login.png");
	background-size: 100%;
}
...
<div id="wrap">
	...
	<!-- 여기에 이미지 추가 -->
	<br><br>
	<!-- <img alt="로그인 이미지 불러오지 못함" width="412" height="230" src="/KoreaHistory/resources/img/introduce/225px-Flag_of_South_Korea.svg.png"> -->
	<!-- <h1>로그인</h1> -->
	<br><br>
	<br><br>
	<br><br>
