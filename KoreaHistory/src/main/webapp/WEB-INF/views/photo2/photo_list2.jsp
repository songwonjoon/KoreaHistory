...
<body>
     <%@ include file="/WEB-INF/views/header.jsp" %>
     	<div>
     		<h3 class="h1">
     			<a style="text-decoration: none; color: black;" href="photo_list2">한일관계</a>
     		</h3>
     	</div>
  ...
  <table class="photo_list_table">
	...
	<c:forEach items="${photo_list2 }" var="photo">
	<tr>
	...
	<c:if test="${photo.pfile eq null }">
		<strong>사진없음</strong>
			...
			<a class="photo_list_tit" href="photo_view2?p_num=${photo.p_num }">
		 ${photo.ptitle }</a>
		 </td>
	...
	<tr>
		<c:if test="${id ne null }">
 		<td class="photo_list_wri" colspan="5"><a class="photo_list_wri_pwri" href="photo_write2">글쓰기</a></td>
		</c:if>
 	</tr>
</table>
<div style="clear: both;"></div>
&nbsp;
	<form action="photo_list2" method="post" id="pform" name="pform">
	...
	<c:if test="${searchPhoto.totPage>1 }">
		<a href="photo_list2?page=1"><img alt="#" src="../resources/img/arrow1.PNG"></a>
		<a href="photo_list2?page=${searchPhoto.page-1 }">
...
<c:choose>
	...
	<c:if test="${searchPhoto.totPage>1 }">
		<a href="photo_list2?page=${searchPhoto.page+1 }"><img alt="#" src="../resources/img/arrow3.png"></a>
		<a href="photo_list2?page=${searchPhoto.totPage }"><img alt="#" src="../resources/img/arrow4.png"></a>
	</c:if>
</c:if>
</div>
</form>
<form>
<div action="photo_list2" method="post" id="searform">
	<c:choose>
		<c:when test="${ptitle }">
