...
<table class="photo_modify_table">
	<form action="photo_mo2" method="post" >
	<input type="hidden" name="p_num" value="${photo_modify2.p_num }">
	<input type="hidden" name="pid" value="${photo_modify2.pid }">
		<tr>
			<td class="photo_modify_td">제목</td>
			<td><input class="photo_modify_td_title" type="text" name="ptitle"
			value="${photo_modify2.ptitle }" size="147">
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<c:if test="${photo_modify2.pfile ne null }">
			<td>
				<img alt="${photo_modify2.pfile }" 
				src="../resources/upload/${photo_modify2.pfile }" style="width: 1200px; height: 700px;"></a>
			</td>
			</c:if>
			<c:if test="${photo_modify2.pfile eq null }"><td  class="photo_modify_td_file"><p><strong>파일없음</strong></p></td></c:if>
		</tr>
		<tr>
			<td class="photo_modify_td">내용</td>
			<td><textarea rows="5" cols="50" id="p_content" name="p_content" >
			${photo_modify2.p_content }</textarea></td>
		</tr>
		...
		<div class="photo_modify_div">
			...
			<a class="photo_modify_return" href="photo_list2">목록보기</a>
			<a class="photo_modify_delete" href="pdelete2?p_num=${photo_modify2.p_num}
							">삭제</a>
		</div>
		</table>
	</form>
